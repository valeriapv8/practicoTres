...
__export(data_types_db_exports, {
  registerMariaDbDbDataTypeParsers: () => registerMariaDbDbDataTypeParsers
});
...
function registerMariaDbDbDataTypeParsers(dialect) {
  ...
  dialect.registerDataTypeParser(["BIGINT"], (value) => {
    return value.string();
  });
}
