...
class MariaDbDialect extends import_core.AbstractDialect {
  ...
  constructor(sequelize, options) {
    ...
    this.connectionManager = new import_connection_manager.MariaDbConnectionManager(this);
    this.queryGenerator = new import_query_generator.MariaDbQueryGenerator(this);
    this.queryInterface = new import_query_interface.MariaDbQueryInterface(this);
    (0, import_data_types_db.registerMariaDbDbDataTypeParsers)(this);
  }
  createBindCollector() {
