...
class MariaDbQueryGeneratorTypeScript extends import_core.AbstractQueryGenerator {
  #internals;
  constructor(dialect, internals = new import_query_generator_internal.MariaDbQueryGeneratorInternal(dialect)) {
